...
describe('a-tab-group', () => {
  ...
  describe('keyboard navigation', () => {
    it('should cycle through tabs using "Right" arrow keys when activation="auto" and placement="top"', async () => {
      const el = await fixture(html`
        <a-tab-group activation="auto" placement="top">
          <a-tab role="heading" selected>Tab 1</a-tab>
          <a-tab-panel>Panel 1</a-tab-panel>
          <a-tab role="heading">Tab 2</a-tab>
          <a-tab-panel>Panel 2</a-tab-panel>
    ...
    it('should not cycle through tabs using "Right" arrow keys when activation="auto", placement="top" and noTabCycle=true', async () => {
      const el = await fixture(html`
        <a-tab-group activation="auto" placement="top" no-tab-cycling>
          <a-tab role="heading" selected>Tab 1</a-tab>
          <a-tab-panel>Panel 1</a-tab-panel>
          <a-tab role="heading">Tab 2</a-tab>
          <a-tab-panel>Panel 2</a-tab-panel>
      ...
      // Pressing "Right" arrow key should keep tab 4 selected and not cycle to tab 1
      await sendKeys({ press: 'ArrowRight' });
    ...
    it('should cycle through tabs using "Down" arrow keys when activation="auto" and placement="start"', async () => {
      const el = await fixture(html`
        <a-tab-group activation="auto" placement="start">
          <a-tab role="heading" selected>Tab 1</a-tab>
          <a-tab-panel>Panel 1</a-tab-panel>
          <a-tab role="heading">Tab 2</a-tab>
          <a-tab-panel>Panel 2</a-tab-panel>
    ...
    it('should not cycle through tabs using "Down" arrow keys when activation="auto", placement="start" and noTabCycling=true', async () => {
      const el = await fixture(html`
        <a-tab-group activation="auto" placement="start" no-tab-cycling>
          <a-tab role="heading" selected>Tab 1</a-tab>
          <a-tab-panel>Panel 1</a-tab-panel>
          <a-tab role="heading">Tab 2</a-tab>
          <a-tab-panel>Panel 2</a-tab-panel>
      ...
      // Pressing "Down" arrow key should keep tab 4 selected and not cycle to tab 1
      await sendKeys({ press: 'ArrowDown' });
    ...
    it('should cycle through tabs using "Right" arrow keys when activation="manual" and placement="top"', async () => {
      const el = await fixture(html`
        <a-tab-group activation="manual" placement="top">
          <a-tab role="heading" selected>Tab 1</a-tab>
          <a-tab-panel>Panel 1</a-tab-panel>
          <a-tab role="heading">Tab 2</a-tab>
          <a-tab-panel>Panel 2</a-tab-panel>
    ...
    it('should not cycle through tabs using "Right" arrow keys when activation="manual", placement="top" and noTabCycling=true', async () => {
      const el = await fixture(html`
        <a-tab-group activation="manual" placement="top" no-tab-cycling>
          <a-tab role="heading" selected>Tab 1</a-tab>
          <a-tab-panel>Panel 1</a-tab-panel>
          <a-tab role="heading">Tab 2</a-tab>
          <a-tab-panel>Panel 2</a-tab-panel>
      ...
      // Pressing "Right" arrow key should keep tab 4 focused and not focus tab 1
      await sendKeys({ press: 'ArrowRight' });
    ...
    it('should not cycle through tabs using "Down" arrow keys when activation="manual", placement="start" and noTabCycling=true', async () => {
      const el = await fixture(html`
        <a-tab-group activation="manual" placement="start" no-tab-cycling>
          <a-tab role="heading" selected>Tab 1</a-tab>
          <a-tab-panel>Panel 1</a-tab-panel>
          <a-tab role="heading">Tab 2</a-tab>
          <a-tab-panel>Panel 2</a-tab-panel>
      ...
      // Pressing "Down" arrow key should keep tab 4 focused and not focus tab 1
      await sendKeys({ press: 'ArrowDown' });
    ...
    it('should not cycle through tabs using "Left" arrow keys when activation="auto", placement="top" and noTabCycling=true', async () => {
      const el = await fixture(html`
        <a-tab-group activation="auto" placement="top" no-tab-cycling>
          <a-tab role="heading">Tab 1</a-tab>
          <a-tab-panel>Panel 1</a-tab-panel>
      ...
      // Pressing "Left" arrow key should keep tab 1 selected and not cycle to tab 4
      await sendKeys({ press: 'ArrowLeft' });
    ...
    it('should cycle through tabs using "Up" arrow keys when activation="auto" and placement="start"', async () => {
      const el = await fixture(html`
        <a-tab-group activation="auto" placement="start">
          <a-tab role="heading">Tab 1</a-tab>
          <a-tab-panel>Panel 1</a-tab-panel>
    ...
    it('should not cycle through tabs using "Up" arrow keys when activation="auto", placement="start" and noTabCycling=true', async () => {
      const el = await fixture(html`
        <a-tab-group activation="auto" placement="start" no-tab-cycling>
          <a-tab role="heading">Tab 1</a-tab>
          <a-tab-panel>Panel 1</a-tab-panel>
      ...
      // Pressing "Up" arrow key should keep tab 1 selected and not cycle to tab 4
      await sendKeys({ press: 'ArrowUp' });
    ...
    it('should cycle through tabs using "Left" arrow keys when activation="manual" and placement="top"', async () => {
      const el = await fixture(html`
        <a-tab-group activation="manual" placement="top">
          <a-tab role="heading">Tab 1</a-tab>
          <a-tab-panel>Panel 1</a-tab-panel>
    ...
    it('should not cycle through tabs using "Left" arrow keys when activation="manual", placement="top" and noTabCycling=true', async () => {
      const el = await fixture(html`
        <a-tab-group activation="manual" placement="top" no-tab-cycling>
          <a-tab role="heading">Tab 1</a-tab>
          <a-tab-panel>Panel 1</a-tab-panel>
      ...
      // Pressing "Left" arrow key should keep tab 1 focused and not focus tab 4
      await sendKeys({ press: 'ArrowLeft' });
    ...
    it('should not cycle through tabs using "Up" arrow keys when activation="manual", placement="start" and noTabCycling=true', async () => {
      const el = await fixture(html`
        <a-tab-group activation="manual" placement="start" no-tab-cycling>
          <a-tab role="heading">Tab 1</a-tab>
          <a-tab-panel>Panel 1</a-tab-panel>
      ...
      // Pressing "Up" arrow key should keep tab 1 focused and not focus tab 4
      await sendKeys({ press: 'ArrowUp' });
